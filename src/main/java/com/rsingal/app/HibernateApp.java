...
public class HibernateApp {
	...
	private void updateEmployee(Integer employeeID, String name) {
		...
		try {
			...
			// If Employee.java (getAccounts()) has inverse="true"(mappedBy = "employee"), ACCOUNT table will be responsible to take care of the relationship not the EMPLOYEE
			...
			// Use @JoinColumn, now EMPLOYEE table will be owner for maintaining relationships and it will make the ACCOUNT.EMPLOYEE_ID_EMPLOYEE as
